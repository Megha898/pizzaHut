...
public class POM {	
    ...
    public By DeliveryLocationText(){
    	return By.xpath("//div[text()='Lulu Mall Bengaluru']");
    }
    ...
    public By VegetarianSwitchBTN(){
    	return By.xpath("(//span[contains(@class,'grey-light border-grey-light')]/span[@class='rounded-full bg-white'])[1]");
    }
    public By PizzaMenu(){
    ...
    public By PizzaPriceAmount(){
    	return By.xpath("//*[@id=\"app\"]/div/div[1]/div[2]/div/div[2]/div[2]/div/div[1]/span[2]");
    }
