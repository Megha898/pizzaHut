...
public class stepDef {
	...
	public void user_wait_for_auto_location_black_pop_up_screen() {
		//CloseButton = new WebDriverWait(driver, Duration.ofSeconds(3)).until(ExpectedConditions.elementToBeClickable(page.BlackScreenCloseBTN()));
	}
	...
	public void user_select_first_auto_populate_drop_down_option() {
		try {
            ...
            Thread.sleep(5000);
            //try{ driver.findElement(page.StartYourOrderWithTime()).click();}catch(Exception e){}
	...
	public void user_see_that_the_pizza_is_getting_added_under_your_basket() {
		/*try {
            driver.findElement(page.AddedPizzaAtBasket()).isDisplayed();
	...
	public void see_price_tag_got_removed_from_the_checkout_button() {
		/*try {
        	Assert.assertFalse(driver.findElement(page.PriceOptionUnderCheckout(driver.findElement(CUBR_Obj.TotalPriceAmount()).getText().trim())).isDisplayed());
